...
folder_path = f'C:/Users/{username}/Northwell Health/CBO (1111 Marcus Ave M04) - Robotic Process Automation/Part A - Hospital/Preregistration/Daily Reports/'
sheet_name = 'Accounts'


def combine_prereg(month: str, year: str):
    if len(month) < 2:
        month = "0" + month
