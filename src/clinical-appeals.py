...
folder_path = 'M:/CPP-Data/CBO Westbury Managers/LEADERSHIP/Bot Folder/Part A/Clinical Appeals/Daily Reports/'
sheet_name = "Detailed Report"


def combine_clinical_appeals(month: str, year: str):
    if len(month) < 2:
        month = "0" + month
