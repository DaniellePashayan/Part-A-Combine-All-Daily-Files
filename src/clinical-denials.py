...
folder_path = 'M:/CPP-Data/CBO Westbury Managers/LEADERSHIP/Bot Folder/Part A/Clinical Denials/Daily Reports/'
sheet_name = "Accounts"

def combine_clinical_denials(month: str, year: str):
    if len(month) < 2:
        month = "0" + month
