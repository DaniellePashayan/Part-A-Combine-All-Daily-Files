...
folder_path = 'C:/Users/dpashayan/Northwell Health/CBO (1111 Marcus Ave M04) - Robotic Process Automation/Part A - Hospital/CHHA Claim Status/Daily Reports/'
sheet_name = "Detailed Report"

def combine_CHHA(month: str, year: str):
    if len(month) < 2:
        month = "0" + month
